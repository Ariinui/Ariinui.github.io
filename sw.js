...
const SHELL_ASSETS = ["/", "/index.html", "/styles.css?v=0b9d131f", "/script.js?v=beb68bf4", "/manifest.json", "/offline.html", "/icons/icon-192.png", "/icons/icon-512.png", "/icons/apple-touch-icon.png"];
