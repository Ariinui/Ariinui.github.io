...
## Corpus Check
- 6 files · ~17,457 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 98 nodes · 94 edges · 34 communities detected
...
1. `main()` - 6 edges
2. `search_exact()` - 4 edges
3. `apply_en_translate()` - 4 edges
...
- **Thin community `Community 8`** (2 nodes): `books: liste de {'book_title', 'chapters': [...]} ; chapter_href(book_idx, chap_`, `render_volume_block()`
...
- **Thin community `Community 11`** (2 nodes): `guide_section_content_html()`, `HTML interne d'une section de guide, sans son <h2> ni le lien 'back to top'.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 12`** (2 nodes): `clean_bom_en_verse_text()`, `parse_bom_en_source()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
